...
export default class MapConfig {
  ...
  static getPlaceName = (latitude, longitude) => {
    ...
    return fetch(
      `https://maps.googleapis.com/maps/api/geocode/json?latlng=${latitude},${longitude}&key=${GOOGLE_KEY}&language=${store.getState().lang.lang
      }&sensor=true`,
    )
      .then((res) => res.json())
      .then((json) => {
  ...
  static API_KEY = 'AIzaSyCXbT4pSyn0P8Myw3EQ9luwwwyBzpweR6s';
