    ...
    return (
      <AppView row>
        <TouchableView
          ...
          circleRadius={10}
          center>
          <AppIcon size={size} color="white" name="image-outline" />
        </TouchableView>
        ...
        <TouchableView
          ...
          circleRadius={10}
          center>
          <AppIcon size={size} color="white" name="camera-outline" />
        </TouchableView>
      </AppView>
    );
  }, [pickImage, size]);
          ...
          return (
            <AppImage
              ...
              <TouchableView
                ...
                <AppIcon color="white" size={10} name="close" type="AntDesign" />
              </TouchableView>
            </AppImage>
          );
        })}
